...
import { HorizontalScrollSection, PulsingLabel, ServicePill, ThemeButton } from "./components";
      ...
      <section className="py-24">
        <div className="container max-w-7xl mx-auto py-16 px-8">
          <div className="grid grid-cols-14 gap-3">
            <motion.div
              className="col-span-3 flex flex-col justify-between gap-6"
            ...
            <div className="col-span-8 flex flex-col gap-4 items-center ">
              <PulsingLabel text="What We Build" />
              <p className="text-5xl font-playfair text-center text-white">
            ...
            <motion.div
              className="col-span-3 flex flex-col items-end justify-between gap-6"
              variants={pillGroupVariants}
              initial="hidden"
              whileInView="visible"
              viewport={{
